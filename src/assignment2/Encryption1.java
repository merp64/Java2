...
public class Encryption1 {
    ...
    public static String encryptWord(String word) {
        ...
        if (word.matches("\\d+")) {
            ...
            throw new IllegalArgumentException(
                "Invalid word: '" + word + "'. Words must contain only letters OR only digits; no special characters."
            );
        }
    }
    ...
    /**
     * Main method:
     * Encrypt each word from the line individually and concatenate 
     * all the encrypted words together to form the encrypted text.
     */
